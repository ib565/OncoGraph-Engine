...
**Query Families:**
- **F1:** Basic entity lookups (therapy↔gene, variant↔gene)
...
**Key Rules:**
- **Cancer Rule:** If disease name contains "cancer" + other words → remove "cancer" token (high-recall). Otherwise use all tokens (high-precision).
